...
class Test_FormManager(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(form_attrs["name"], form_manager.forms[0].name)
        self.assertEqual(1, len(form_manager.forms[0].fields))
        self.assertEqual(1, len(form_manager.forms[0].controls))
    ...
    def test_parse(self):
        ...
        self.assertEqual(form_attrs["name"], forms[0].name)
        self.assertEqual(1, len(forms[0].fields))
        self.assertEqual(1, len(forms[0].controls))
